...
function JoinRoomShell({ children }: { children: React.ReactNode }) {
  return (
...
function JoinRoomFallback() {
  // Lightweight skeleton shown while useSearchParams is suspended during
  // prerender / hydration. Matches the layout of the real form to avoid jumps.
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center gap-2">
        <Badge tone="green">Join room</Badge>
...
export default function JoinRoomPage() {
  return (
    <JoinRoomShell>
      <React.Suspense fallback={<JoinRoomFallback />}>
        <JoinRoomForm />
      </React.Suspense>
    </JoinRoomShell>
  );
